...
class ConfigLoadingTest(unittest.TestCase):
    ...
    def test_hermes_model_defaults_to_flash_and_env_override_wins(self) -> None:
        with patch.dict(os.environ, {}, clear=True):
            self.assertEqual(load_config().hermes_model, "deepseek-v4-flash")
        with patch.dict(
    ...
    def test_reviewer_flags_default_to_safe_enabled_values(self) -> None:
        ...
        self.assertEqual(config.vector_memory_index_path, config.data_dir / "memory_bge_vector_index.bin")
        self.assertEqual(config.vector_memory_metadata_path, config.data_dir / "memory_bge_vector_index.json")
