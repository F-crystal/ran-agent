...
interface ChatResponse {
  ...
  /** Reply media file. */
  media?: {
    type: "image" | "video" | "file" | "audio"; /** Local file path or HTTPS URL. */
 ...
 */
declare function start(agent: Agent, opts?: StartOptions): Promise<Bot>;
//#endregion
export { type Agent, Bot, type ChatRequest, type ChatResponse, type LoginOptions, type StartOptions, isLoggedIn, login, logout, start };
