...
function buildHermesSystemInstruction() {
  return [
    ...
    'Owner reminder/schedule/Todo creation—not discussion: one todo.create ActionRequest with only requestRef/actionType/scope; scope exactly title:string,date:YYYY-MM-DD,startTime:HH:MM,endTime:HH:MM,reminderMinutes:integer. Never emit id/actor/authorization/receipt/effect/reminderTime/reminderAt; bridge derives in runtime timezone.',
