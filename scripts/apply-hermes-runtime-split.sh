...
NODE_BRIDGE_QUICK_ACK_ENABLED_DEFAULT="${RAN_AGENT_DEPLOY_NODE_BRIDGE_QUICK_ACK_ENABLED:-false}"
NODE_BRIDGE_QUICK_ACK_TIMEOUT_MS_DEFAULT="${RAN_AGENT_DEPLOY_NODE_BRIDGE_QUICK_ACK_TIMEOUT_MS:-4500}"
NODE_BRIDGE_QUICK_ACK_TEXT_DEFAULT="${RAN_AGENT_DEPLOY_NODE_BRIDGE_QUICK_ACK_TEXT:-收到，正在处理，稍后发送结果。}"
