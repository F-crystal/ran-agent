...
HERMES_LITE_SOFT_RESET_ENABLED_DEFAULT="${RAN_AGENT_DEPLOY_HERMES_LITE_SOFT_RESET_ENABLED:-false}"
HERMES_LITE_SOFT_RESET_DRY_RUN_DEFAULT="${RAN_AGENT_DEPLOY_HERMES_LITE_SOFT_RESET_DRY_RUN:-true}"
