...
HERMES_ACTION_GATE_MODE_DEFAULT="${RAN_AGENT_DEPLOY_HERMES_ACTION_GATE_MODE:-observe}"
...
restart_services() {
  ...
  sleep 1
  reset_failed_if_loaded ran-agent-hermes.service ran-agent-hermes-full.service ran-agent-ombre-brain.service
  if ombre_brain_enabled; then
...
verify_runtime() {
  ...
  for node_env in \
    ...
    "PERSONAL_AGENT_DAILY_CARRYOVER_ENABLED=$PERSONAL_AGENT_DAILY_CARRYOVER_ENABLED_DEFAULT" \
    "PERSONAL_AGENT_DAILY_CARRYOVER_HOUR=$PERSONAL_AGENT_DAILY_CARRYOVER_HOUR_DEFAULT" \
    "PERSONAL_AGENT_DAILY_CARRYOVER_MINUTE=$PERSONAL_AGENT_DAILY_CARRYOVER_MINUTE_DEFAULT"; do
