...
AI_DAILY_DIGEST_ENABLED_DEFAULT="${RAN_AGENT_DEPLOY_AI_DAILY_DIGEST_ENABLED:-false}"
...
prepare_ombre_runtime() {
  ...
  if run_as_runtime_identity /usr/bin/env -i \
    ...
    RAN_AGENT_OMBRE_PYTHON_BIN="${RAN_AGENT_OMBRE_PYTHON_BIN:-}" \
    RAN_AGENT_TEST_MODE="${RAN_AGENT_TEST_MODE:-0}" \
