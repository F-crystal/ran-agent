...
HERMES_CONTEXT_INJECTION_MODE_DEFAULT="${HERMES_CONTEXT_INJECTION_MODE:-auto}"
HERMES_RECENT_TEXT_TURNS_DEFAULT="${HERMES_RECENT_TEXT_TURNS:-4}"
HERMES_RECENT_TEXT_CHAR_BUDGET_DEFAULT="${HERMES_RECENT_TEXT_CHAR_BUDGET:-2400}"
HERMES_GLOBAL_RECENT_TURNS_DEFAULT="${HERMES_GLOBAL_RECENT_TURNS:-2}"
HERMES_GLOBAL_RECENT_CHAR_BUDGET_DEFAULT="${HERMES_GLOBAL_RECENT_CHAR_BUDGET:-800}"
HERMES_ACTIVE_TOPIC_CHAR_BUDGET_DEFAULT="${HERMES_ACTIVE_TOPIC_CHAR_BUDGET:-400}"
HERMES_LITE_SOFT_RESET_ENABLED_DEFAULT="${HERMES_LITE_SOFT_RESET_ENABLED:-false}"
HERMES_LITE_SOFT_RESET_DRY_RUN_DEFAULT="${HERMES_LITE_SOFT_RESET_DRY_RUN:-true}"
HERMES_LITE_SOFT_RESET_MAX_DIGEST_CHARS_DEFAULT="${HERMES_LITE_SOFT_RESET_MAX_DIGEST_CHARS:-1200}"
HERMES_LITE_SOFT_RESET_KEEP_LAST_N_DEFAULT="${HERMES_LITE_SOFT_RESET_KEEP_LAST_N:-4}"
HERMES_LITE_SOFT_RESET_STATE_FILE_DEFAULT="${HERMES_LITE_SOFT_RESET_STATE_FILE:-.ran_agent_state/hermes/session_maintenance.json}"
HERMES_LITE_SOFT_RESET_DIGEST_DIR_DEFAULT="${HERMES_LITE_SOFT_RESET_DIGEST_DIR:-.ran_agent_state/hermes/digests/}"
...
verify_runtime() {
  ...
  for node_env in \
    ...
    "HERMES_ACTIVE_TOPIC_CHAR_BUDGET=$HERMES_ACTIVE_TOPIC_CHAR_BUDGET_DEFAULT" \
    "HERMES_LITE_SOFT_RESET_ENABLED=$HERMES_LITE_SOFT_RESET_ENABLED_DEFAULT" \
    "HERMES_LITE_SOFT_RESET_DRY_RUN=$HERMES_LITE_SOFT_RESET_DRY_RUN_DEFAULT"; do
