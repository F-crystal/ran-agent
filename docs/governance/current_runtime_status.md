...
hermes_v020_unified_runtime_candidate: RELEASE_CANDIDATE_READY_FOR_RUNTIME_APPLY for exact artifact 44572a7be51e66b43aa5f15b9d8442bff52052d4dd0167b75dd85206660cff30 / tree 3049a082c0d1794bdf0f5d681132eaeb84fd7006b5ddb1514694717874214698; one offline gateway, 62 ELF, 34 compiled imports, relocation/read-only/terminfo/zero-cron/zero-lazy/zero-Tirith passed; its exact eight-file read-only MCP overlay passed isolated mount/network verification and a 218-second systemd keepalive run with stable gateway/eight MCP PIDs, isolated Hermes/Node mount views, zero ping degradation, zero business-state delta, and temporary cleanup; 899821144-byte preliminary capacity headroom after crediting the already-staged root-only artifact; exact final-candidate dry-run and separate BindReadOnlyPaths authorization remain pending; not deployed
