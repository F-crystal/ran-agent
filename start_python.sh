...
export PERSONAL_AGENT_KNOWLEDGE_CRON_HOURS="${PERSONAL_AGENT_KNOWLEDGE_CRON_HOURS:-6,12,18,23}"
export PERSONAL_AGENT_KNOWLEDGE_CRON_MINUTE="${PERSONAL_AGENT_KNOWLEDGE_CRON_MINUTE:-0}"
export PERSONAL_AGENT_DAILY_CARRYOVER_ENABLED="${PERSONAL_AGENT_DAILY_CARRYOVER_ENABLED:-true}"
export PERSONAL_AGENT_DAILY_CARRYOVER_HOUR="${PERSONAL_AGENT_DAILY_CARRYOVER_HOUR:-4}"
export PERSONAL_AGENT_DAILY_CARRYOVER_MINUTE="${PERSONAL_AGENT_DAILY_CARRYOVER_MINUTE:-0}"
