...
export AI_DAILY_DIGEST_ENABLED="${AI_DAILY_DIGEST_ENABLED:-false}"
export AI_DAILY_DIGEST_HOUR="${AI_DAILY_DIGEST_HOUR:-10}"
export AI_DAILY_DIGEST_MINUTE="${AI_DAILY_DIGEST_MINUTE:-0}"
...
export PERSONAL_AGENT_QWEN_TIMEOUT_SECONDS="${PERSONAL_AGENT_QWEN_TIMEOUT_SECONDS:-300}"
...
export OMBRE_VAULT_LEGACY_PATH="${OMBRE_VAULT_LEGACY_PATH:-$ROOT_DIR/.ran_agent_state/ombre_vault}"
